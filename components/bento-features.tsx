  ...
  return (
    <div className="w-full max-w-7xl mx-auto my-20 px-4 md:px-8">
      ...
      <p className="max-w-lg text-sm text-neutral-600 text-center mx-auto mt-4 dark:text-neutral-400">
        Build with ease, leave complexities to us.
      </p>
      <div className="mt-20  grid cols-1 md:grid-cols-5 gap-4 md:auto-rows-[25rem]">
        <Card className="flex flex-col justify-between md:col-span-3">
          ...
          <CardContent className="h-40">
            <CardTitle>A to Z Deployments</CardTitle>
            <CardDescription>
              We handle everything from A to Z, so you can focus on what is
              important
            </CardDescription>
          </CardContent>
        </Card>
  ...
  return (
    <div className="relative w-fit mx-auto p-4 flex items-center justify-center">
      <motion.div
        ...
        className="absolute inset-0 h-full border border-pb-orange dark:border-neutral-800 w-full"
      >
        <motion.div
          initial={{ opacity: 0 }}
          animate={{ opacity: 1 }}
          transition={{ duration: 1.1, ease: "easeInOut" }}
          className="absolute -top-1 -left-1 h-2 w-2 dark:bg-neutral-800 bg-pb-blue"
        />
        <motion.div
          initial={{ opacity: 0 }}
          animate={{ opacity: 1 }}
          transition={{ duration: 1.1, ease: "easeInOut" }}
          className="absolute -top-1 -right-1 h-2 w-2 dark:bg-neutral-800 bg-pb-blue"
        />
        <motion.div
          initial={{ opacity: 0 }}
          animate={{ opacity: 1 }}
          transition={{ duration: 1.1, ease: "easeInOut" }}
          className="absolute -bottom-1 -left-1 h-2 w-2 dark:bg-neutral-800 bg-pb-blue"
        />
        <motion.div
          initial={{ opacity: 0 }}
          animate={{ opacity: 1 }}
          transition={{ duration: 1.1, ease: "easeInOut" }}
          className="absolute -bottom-1 -right-1 h-2 w-2 dark:bg-neutral-800 bg-pb-blue"
        />
      </motion.div>
      {children}
    </div>
